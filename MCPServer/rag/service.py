...
# service.py 位于 MCPServer/rag/service.py
# retriever.py 位于 MCPServer/rag/retriever/retriever.py
# 用绝对路径 import 确保无论从哪里调用都能正常工作
import sys
_RAG_ROOT = Path(__file__).parent          # MCPServer/rag/
_MCP_ROOT = _RAG_ROOT.parent              # MCPServer/
